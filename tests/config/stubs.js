...
export const itemStub = {
  allergen_classes: "allergen-gluten allergen-fish",
  ...
  delivery_days: null,
  description: "Thinly sliced Yellowfin Tuna, avocado and morita mayo, topped with crispy leeks",
  display_options: 0,
  end_date: null,
  end_date_str: "",
  favoriteId: null,
  ...
  kds_groups: [],
  large_image_url: "//s3.amazonaws.com/betterboh/u/img/prod/51/1513817671_tuna_tostada_lg.jpg",
  length: null,
  lineItemInCart: undefined,
  max_quantity: 0,
  menu_position: 3,
  min_quantity: 1,
  name: "Tuna Tostada",
  ...
  short_description: "",
  short_name: "Tuna Tostada",
  shorthand: "",
  sizes: [],
  slug: "tuna-tostada",
  small_image_url: "//s3.amazonaws.com/betterboh/u/img/prod/51/1513817670_tuna_tostada_sm.jpg",
  start_date: null,
  start_date_str: "",
  tag_classes: "",
  tags: "",
